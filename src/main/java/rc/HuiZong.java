...
public class HuiZong {
    ...
    public static void main(String[] args) throws Exception {
       String filePath="C:\\Users\\Administrator\\Desktop\\rc_cgs";
    ...
    private static void getFiles(String filePath) throws Exception {
        ...
        for(File file:files){
            ...
            FileOutputStream fo = new FileOutputStream("C:\\Users\\Administrator\\Desktop\\DS\\"+file.getName()); // 输出到文件
            workbook.write(fo);
        }
    ...
    private static Workbook readSheet(Workbook wb,int type) throws FileNotFoundException {
        ...
        for(Row r:wb.getSheetAt(0)){
            ...
            String car=getCellValue(r.getCell(3));
            if(car.equals("无"))continue;
            int n=0;
//            for(Cell c:r) {
